...
const WISHES = [
  { id: 1,  text: "กินหมูกะท๊าา",                color: "#ffd6e7" },
  { id: 2,  text: "นอนอยู่บ้านทั้งวัน", color: "#fce4ec" },
  { id: 3,  text: "ขับรถไปเที่ยวแบบไม่มีแผน",        color: "#fff0f8" },
  { id: 4,  text: "ไปนอนโง่ๆต่างจังหวัด",           color: "#ffd6e7" },
  { id: 5,  text: "ทำกับข้าวกินทุกเย็น",          color: "#fce4ec" },
  { id: 6,  text: "ไปเที่ยวเหนือ",  color: "#fff0f8" },
  { id: 7,  text: "ไปทำบุญทุกที่",          color: "#ffd6e7" },
  { id: 8,  text: "บริจาคของมูลนิธิ",         color: "#fce4ec" },
  { id: 9,  text: "กินขนมหวานทุกอาทิตย์",            color: "#fff0f8" },
  { id: 10, text: "นอนดูหนังด้วยกันอาทิตย์ละครั้ง",            color: "#ffd6e7" },
];
