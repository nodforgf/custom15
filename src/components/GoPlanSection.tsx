...
const WISHES = [
  { id: 1,  text: "ถ่ายรูปตู้ถ่ายรูปด้วยกัน จุ๊บบกันทุกรูป",                color: "#ffd6e7" },
  { id: 2,  text: "ไปทะเล ดูพระอาทิตย์ตกกด้วยกัน🌅", color: "#fce4ec" },
  { id: 3,  text: "นอนกอดกานนทั้งวัน จับมือกันตลอดด",        color: "#fff0f8" },
  { id: 4,  text: "จูบกัน🥺💋",           color: "#ffd6e7" },
  { id: 5,  text: "yed yed 🥴",          color: "#fce4ec" },
  { id: 6,  text: "ดูหนังด้วยกันในโรงหนังง แยะก็ดูด้วยกันที่ห้องเค้าา",  color: "#fff0f8" },
  { id: 7,  text: "ทำกับข้าวกินด้วยกัน กินของอร่อยๆ",          color: "#ffd6e7" },
  { id: 8,  text: "แต่งตัวคู่กันแมทช์สีกันน",         color: "#fce4ec" },
  { id: 9,  text: "เลี้ยงน้อนหมาด้วยกันสักตัวว",            color: "#fff0f8" },
  { id: 10, text: "ไปเที่ยวด้วยกันทุกที่",            color: "#ffd6e7" },
];
