                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>บิบี๋คนสวย🫶🏻💝 สุขสันต์วันครบรอบ 5 เดือนนค่ะ เราพากันมาถึงเดือนที่ห้าแนะแฟนน แต่นับรวมๆจริงๆก็ 7 เดือนแย้วนะ ตั้งแต่แรกจนถึงทุกวันนี้ เค้าก็ยังตกหลุมรักเธอเหมือนเดิม มากขึ้นทุกวัน เธอชอบเค้าก่อนก็จริง แต่เค้าน่ะหลงเธอกลับแบบพันล้านเท่าเยยย เธอทำเค้าขนาดนี้ได้แงะะ ใส่สเน่ห์อาไยลงไป จาคลั่งตายยทุกวัน ขอให้เราเป็นคู่ที่น่ายักๆแบบนิไปตลอดน้าบิบี๋ ถึงตัวเราจะไกลกันแค่ไหน แต่ใจเราสองคนม่ายเคยไกลกันสักนิด ตัวติดกันมาตลอดเลยแหนะ ตลอดเวลาที่ผ่านมามีแต่ความสุขมากมายเยย ช่วงเวลาที่ได้ใช้กับเธอน่ะ มันดีจัง จนอยากให้เรามีกันแบบนี้ไปนานนานเยย เค้าจริงจังกับเธอมากๆจริงๆ ทุกวันนี้เค้าเอาแต่คิดว่ายังไงก็ต้องเป็นเธอ ภาพในอนาคตเค้าก็เธอเต็มไปหมด คนที่เป็นทุกอย่างของเค้าเลย เป็นโลกของเค้า เป็นบ้านของเค้า เป็นแฟนสุดที่รัก เป็นเพื่อนสนิทที่สุดของเค้า เค้าเชื่อว่าถ้าเราจับมือกันแน่นๆแบบนี้ เราไปด้วยกันได้ไกลแน่นอนอยู่แย้วว อาไยทิมะดีไม่ต้องไปสนมันอย่างแบบว่าเราจาไปกันรอดมั้ย มะอาวมะคิดแบบนั้นนะ มาโฟกัสที่ปัจจุบันที่เรามีกัน และอนาคตที่เราวางแพลนกันเอาไว้นะคะ เค้าอยากมีเธอข้างๆเค้าแบบนี้มากมากกไปนานแสนนาน ทุกก้าวในชีวิตของเธอ จนเธอเรียนจบ เราได้เจอกัน ได้ตื่นมาเจอหน้าทุกเช้า ได้ดูแลเธอ ไปกับเธอทุกที่ ไม่ว่าตลอดที่ผ่านมา มันจะมีอะไรเกิดขึ้นระหว่างทาง ทั้งทะเลาะกันหนักหลายครั้ง ไม่เข้าใจกัน น้อยใจกันไม่รู้กี่ครั้ง เสียใจมีน้ำตาแค่ไหน เค้าขอให้เรายังผ่านไปด้วยกัน อยู่ทะเลาะปรับกันไปทุกวันทุกครั้ง ให้เค้าได้ยั่วโมโหแฟนกวนแฟนไปนานนๆ เวลาแฟนวีนมานนน่าย้ากกเหมือนปีศาจยู้กแมว มันจะไม่มีคำว่าเลิกนะแฟน โนโน คอยเตือนกันสอนกันไปตลอด อยากยอมแพ้ยังไงก็ต้องหันมาคุยกัน คุยกันเยอะๆเลย มาถึงขนาดนี้แล้วว จริงมั้ยแฟน กว่าจะหากันเจอ ทุกวันนี้เรารู้จักกันดี เข้ากันได้ดีมากขึ้นเรื่อยๆ ผ่านการปรับอะไรกันมาตั้งเยอะ อยู่คบกันหลายๆปีเลยนะ เอาเป็นว่าา เค้ารักเธอมากเลย การได้ให้ความรักเธอ และได้รับความรักจากเธอ เค้ารู้สึกโชคดีที่สุด ไปกานนต่อบิบี๋ รักสุดหัวจายยนะ💖</p>
                                    </div>
